...
export RT-AC68U_BASE := IPV6SUPP=y HTTPS=y ARM=y BCM57=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y \
                        SAMBA3=y MEDIASRV=n MODEM=y MODEMPIN=y BECEEM=n PARENTAL2=n ACCEL_PPTPD=n PRINTER=n STAINFO=y \
                        WEBDAV=n CLOUDSYNC=n USB="USB" GRO=y APP="none" PROXYSTA=y FTPCLIENT=n SAMBACLIENT=n \
                        DNSMQ=y SHP=y NVRAM_64K=y RTAC68U=y BCMWL6=y BCMWL6A=y TUNEK="n" BCM5301X=y DISK_MONITOR=n \
                        BTN_WIFITOG=y TURBO=n BCM4352_5G=y OPTIMIZE_XBOX=y ODMPID=y LED_BTN=y ROG=n SSD=n EMAIL=n \
                        LED_BTN_MODE=y BCMSMP=y XHCI=y SSH=y JFFS2=y NFS=y OPENVPN=y USER_LOW_RSSI=y DROPBOXCLIENT=y \
                        TIMEMACHINE=n MDNS=n VPNC=y BRCM_NAND_JFFS2=n JFFS2LOG=n BCMFA=y BWDPI=n ADBLOCK=n \
                        DUMP_OOPS_MSG=y LINUX_MTD="64" BCM7=n TEMPROOTFS=y DEBUGFS=y SWEBDAVCLIENT=n SNMPD=n TOR=n \
                        CTF_PPTP_L2TP=y BCM5301X_TRAFFIC_MONITOR=n \
                        TFAT=n HFS="tuxera" NTFS="tuxera" IPSEC=n REPEATER=y DUALWAN=n DNSFILTER=n SAMBA36=n UPNPIGD2=n
...
export VTX_BASE6 := $(filter-out RTAC68U=y BWDPI=n DEBUGFS=y CLOUDSYNC=n JFFS2LOG=n DUMP_OOPS_MSG=y TURBO=n LINUX_MTD="64",$(RT-AC68U_BASE))
